...
import { Message, messages } from "@/testing/testConvo"
...
export default function PatientHome() {
    return(
        ...
        <section className="columns-2 items-start h-full">
            ...
            <div className="h-[calc(100vh-56px)] bg-slate-200 rounded-tl-3xl pt-8 px-10 flex flex-col overflow-hidden">
                <div className="font-bold h-16 text-4xl">Conversation with AI</div>
