        ...
        <div className="content-center space-y-4 text-lg h-[calc(100vh-56px)] overflow-auto snap-y pr-4">
            {doctorList?.map((doctor, index : number) => (
                <div key={index} className="text-center snap-start">
                    <div className={`${(sidebarIndex == index && path === '/home') ? 'bg-white font-bold' : 'cursor-pointer bg-secondary-400 hover:bg-secondary-200 transition duration-500'} py-4 rounded-tr-3xl rounded-br-3xl`} onClick={() => {
